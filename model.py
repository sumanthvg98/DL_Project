...
# Intializing the GRU Cell with the same parameters as the GRU Layer
...
# The main WaveRNN Model
class WaveRNN(nn.Module):

    def __init__(self, n_mels, hop_length, num_bits, audio_embedding_dim, conditioning_rnn_size, rnn_size, fc_size):
    ...
    # Generating input mel-spectrograms
    def generate_audio_from_mel(self, mel):
        wav = []
